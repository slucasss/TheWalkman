...
class Debug
{
	...
	void Draw(sf::RenderTexture* pRenderWindow);
...
public:
	...
	static void DrawText(float x, float y, const std::string& text, int size, float ratioX, float ratioY, const sf::Color& color);
