...
void Debug::Draw(sf::RenderTexture* pRenderWindow)
{
...
{
	DrawText(x, y, text, 20, 0.f, 0.f, color);
}

void Debug::DrawText(float x, float y, const std::string& text, int size, float ratioX, float ratioY, const sf::Color& color)
{
