...
namespace ImGui
{
    ...
    IMGUI_API void          SetItemTooltip(const char* afmt, ...) IM_FMTARGS(1);                 // set a text-only tooltip if preceeding item was hovered. override any previous call to SetTooltip().
