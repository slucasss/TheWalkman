...
![image info](Assets/Readme/Running.gif)

  - The ability to change the environnement depending on wich music you are listening to (Jazz or Rock)
![image info](Assets/Readme/MusicChange1.gif)
![image info](Assets/Readme/MusicChange2.gif)


  - Boss fight : rythme game similar to like Guitar Hero
![image info](Assets/Readme/Boss.gif)

  - Different ennemies (rats and bats)
  - Lighting shaders to improve caves atmosphere
  - Menus

![image info](Assets/Readme/PauseMenu.gif)
![image info](Assets/Readme/ScreenMenu.png)
